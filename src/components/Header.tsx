...
import ModalMap from "../pages/ModalMap";

type HeaderProp = { ghRepo: string };

const Header: React.FC<HeaderProp> = ({ ghRepo }) => {
  const [active, setActive] = React.useState(false);
  const [city, setCity] = React.useState("Виберіть місто");
  ...
  return (
    <div className="header">
      <div className="container">
        ...
        <a className="header__city" onClick={() => setActive(true)}>{city}</a>
        <ModalMap active={active} setActive={setActive} city={city} setCity={setCity}/>
        {location !== '/React-Sushi/Cart' &&
          <>
            <Search />
